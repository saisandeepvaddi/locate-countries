...
export const countriesBaseData: Record<string, CountryBaseData> = {
  AF: {
    name: 'Afghanistan',
    'alpha-2': 'AF',
    'alpha-3': 'AFG',
...
export const countriesEnglishNames = Object.values(countriesBaseData).map(
